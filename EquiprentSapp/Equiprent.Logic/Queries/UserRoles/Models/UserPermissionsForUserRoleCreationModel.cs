...
{
    public class UserPermissionsForUserRoleCreationModel
    {
        public List<UserPermissionForUserRoleCreationListGroupModel> List { get; set; }

        public UserPermissionsForUserRoleCreationModel() => List = new List<UserPermissionForUserRoleCreationListGroupModel>();
    }
