    ...
    public static class DependencyRegistrar
    {
        public static void AddCommandQueryHandler(this IServiceCollection services, Type dependencyInterfaceType)
        {
            var dependencies = dependencyInterfaceType.Assembly
                ...
                .Select(type => new DependencyModel(
                    interfaceType: type.GetInterfaces().First(t => t.IsGenericType && t.GetGenericTypeDefinition() == dependencyInterfaceType),
                    interfaceImplementerType: type));
