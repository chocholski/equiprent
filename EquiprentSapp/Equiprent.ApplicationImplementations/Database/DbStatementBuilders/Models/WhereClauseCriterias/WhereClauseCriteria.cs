using Equiprent.ApplicationImplementations.Database.DbStatementBuilders.Models.FilterTypes;
using Equiprent.ApplicationImplementations.Database.DbStatementBuilders.Models.MatchModes;
using Equiprent.ApplicationImplementations.Database.DbStatementBuilders.Models.SearchOperators;
...
namespace Equiprent.ApplicationImplementations.Database.DbStatementBuilders.Models.WhereClauseCriterias
{
    public class WhereClauseCriteria : IWhereClauseCriteria
    {
        ...
        public List<IWhereClauseCriteria> Criteria { get; } = new();
