...
{
    public class GetEquipmentSelectionListQueryHandler : IRequestHandler<GetEquipmentSelectionListQueryRequest, string>
    {
        public async Task<string> Handle(GetEquipmentSelectionListQueryRequest request, CancellationToken cancellationToken)
        {
            ...
            var baseManufacturerTableJoinColumn = new CustomQueryColumn(nameof(Equipment.ManufacturerId)) with
            {
                ...
                with
                {
                    ColumnAlias = nameof(EquipmentSelectionListQueryModel.ManufacturerId),
                    TableAlias = "m",
                }
            };
            ...
            var query = new CustomQueryBuilder(request.DbContext, tableName: equipmentTableName, tableAlias: "e")
                ...
                .AddEmptySelectColumnWithAlias(nameof(EquipmentSelectionListQueryModel.TypeName))
